...
<section class="hero">
  <div class="hero-grid">
    <div class="hero-content">
      <span class="tag">Available for freelance, consultation and collaboration</span>
      <h1>Sunbla Khan</h1>
      <p>
      ...
      <div class="actions">
        ...
        <a class="btn btn-ghost" href="https://topmate.io/sunbla_khan" target="_blank" rel="noopener noreferrer">Book 1:1 on Topmate</a>
...
<section>
  ...
  <div class="grid">
    <article class="card">
      ...
      <p class="meta">Berliner Hochschule fur Technik (BHT), Berlin | Oct 2025 - Present</p>
      <p>Focused on applied analytics, machine learning workflows, and data-driven systems design.</p>
    </article>
    <article class="card">
      <h3>Bachelor's in Software Engineering</h3>
      <p class="meta">Muhammad Ali Jinnah University (MAJU), Karachi | Feb 2020 - Feb 2024</p>
      <p>Final Year Project: <strong>FulfillMaster</strong> warehouse logistics management system using React and Django.</p>
    </article>
    <article class="card">
      <h3>Certifications</h3>
      <ul>
        <li>Python for Data Science, AI & Development (IBM/Coursera)</li>
        <li>Data Science Methodology (IBM/Coursera)</li>
...
<section>
  ...
  <div class="grid">
    <article class="card">
      <h3>Operations & AI Automation Specialist</h3>
      <p class="meta">9INESPACES (Remote) | Jan 2025 - Sept 2025</p>
      <ul>
        <li>Designed and launched an AI assistant (ManyChat + n8n) trained on 500+ real customer conversations.</li>
        <li>Automated ~80% of routine support queries, improving response consistency and reducing manual handling.</li>
        <li>Built a HubSpot lead scoring pipeline (Hot/Warm/Cold) that improved team efficiency by 30%.</li>
        <li>Integrated calendar and data workflows, reducing scheduling delay from 24 hours to ~15 minutes.</li>
      </ul>
    </article>
    <article class="card">
      <h3>Operations Manager & Automation Specialist</h3>
      <p class="meta">Kiddy Online School, New York | Dec 2019 - Oct 2023</p>
      <ul>
        <li>Automated student onboarding flows across Zapier, Pipedrive, Twilio, and Google tools, cutting cycle time by 50%.</li>
        <li>Created and standardized 25+ SOPs, reducing distributed team training time by 40%.</li>
        <li>Used CRM and Excel-based analysis to identify process bottlenecks and redesign support operations.</li>
      </ul>
    </article>
  </div>
</section>
  ...
  <div class="grid">
    ...
    <article class="card">
      ...
      <ul>
        ...
        <li>Adaptability under uncertainty</li>
        <li>Leadership and mentoring mindset</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="profile-panel">
  <div class="profile-copy">
    ...
    <p>If you are hiring for Data Science, AI Automation, or operations-focused roles, I would love to connect and discuss how I can contribute.</p>
    <div class="actions">
      <a class="btn btn-primary" href="mailto:sunblakhan7589@gmail.com">Send Email</a>
      <a class="btn btn-ghost" href="https://wa.me/491623774842" target="_blank" rel="noopener noreferrer">Message on WhatsApp (+49 162 3774842)</a>
      <a class="btn btn-ghost" href="https://www.linkedin.com/posts/sunbla-khan-6a1920172" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a>
    </div>
  </div>
</section>
